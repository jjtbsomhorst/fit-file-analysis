...
<body>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      var markings = [{
        color: "rgba(203, 75, 75, 1)",
        lineWidth: 2,
        xaxis: {
          from: <?php echo $power_metrics['Normalised Power']; ?>,
          to: <?php echo $power_metrics['Normalised Power']; ?>
        }
      }];
      ...
      var power_distribution_options = {
        ...
        xaxis: {
          ...
          tickSize: 100,
          tickFormatter: function(label, series) {
            return label.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + ' w';
          }
        },
        yaxis: {
          min: 0,
      ...
      var o = plot_pd.pointOffset({
        x: <?php echo $power_metrics['Normalised Power']; ?>,
        y: plot_pd.height()
      });
